# Manual Setup Steps for Minions Qa-reports
...
Go to **GitHub → mxn2020/minions-qa-reports → Settings → Secrets and variables → Actions** and add:

| Secret | Description | Where to get it |
|--------|-------------|-----------------|
| `NPM_TOKEN` | npm publish token | [npmjs.com → Access Tokens](https://www.npmjs.com/settings/~/tokens) |
| `PYPI_TOKEN` | PyPI API token for `minions-qa-reports` | [pypi.org → Account Settings → API tokens](https://pypi.org/manage/account/#api-tokens) |
...
### Web App (Playground)
- **Netlify site name**: `minions-qa-reports-web`
- **GitHub repo**: `mxn2020/minions-qa-reports`
- **Base directory**: `apps/web`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/web/dist`
- **Custom domain**: `qa-reports.minions.wtf`

### Documentation
- **Netlify site name**: `minions-qa-reports-docs`
- **GitHub repo**: `mxn2020/minions-qa-reports`
- **Base directory**: `apps/docs`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/docs/dist`
- **Custom domain**: `qa-reports.minions.help`

### Blog
- **Netlify site name**: `minions-qa-reports-blog`
- **GitHub repo**: `mxn2020/minions-qa-reports`
- **Base directory**: `apps/blog`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/blog/dist`
- **Custom domain**: `qa-reports.minions.blog`
...
|--------|------|------|-------|
| Docs | CNAME | `qa-reports.minions.help` | _(Netlify subdomain)_ |
| Blog | CNAME | `qa-reports.minions.blog` | _(Netlify subdomain)_ |
| App  | CNAME | `qa-reports.minions.wtf` | _(Netlify subdomain)_ |
...
Your packages:
- SDK: [`@minions-qa-reports/sdk`](https://www.npmjs.com/package/@minions-qa-reports/sdk)
- CLI: [`@minions-qa-reports/cli`](https://www.npmjs.com/package/@minions-qa-reports/cli)
...
Your package: [`minions-qa-reports`](https://pypi.org/project/minions-qa-reports/)
...
| Item | Value |
|------|-------|
| Project | `minions-qa-reports` |
| SDK (npm) | `@minions-qa-reports/sdk` |
| CLI (npm) | `@minions-qa-reports/cli` |
| Python (PyPI) | `minions-qa-reports` |
| GitHub | `github.com/mxn2020/minions-qa-reports` |
| Docs domain | `qa-reports.minions.help` |
| Blog domain | `qa-reports.minions.blog` |
| App domain | `qa-reports.minions.wtf` |
