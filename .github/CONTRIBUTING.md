# Contributing to Minions Qa-reports

Thank you for your interest in contributing to Minions Qa-reports!

## Getting Started

1. Fork the repository
2. Clone your fork: `git clone https://github.com/YOUR_USERNAME/minions-qa-reports.git`
