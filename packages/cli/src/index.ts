...
/**
 * @minions-qa-reports/cli — CLI for Minions Qa-reports
 *
...
import { customTypes } from '@minions-qa-reports/sdk';
...
program
    ...
    .action(() => {
        console.log(chalk.bold('Minions Qa-reports'));
        console.log(chalk.dim('Aggregated test reports, health dashboards, trend analysis, and regression alerts'));
        console.log('');
        console.log(`  SDK:    ${chalk.cyan('@minions-qa-reports/sdk')}`);
        console.log(`  CLI:    ${chalk.cyan('@minions-qa-reports/cli')}`);
        console.log(`  Python: ${chalk.cyan('minions-qa-reports')}`);
